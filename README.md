...
- Discovery: A process by which an entity can find another entity or a set of entities of a type that can perform a desired function. **The purpose of this work effort is limited to just this element. It is described in more detail in the Problem Statement, below.**
